...
export function LinkPreview({ url }: { url: string }) {
  ...
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className={CARD_CLASS} style={{ background: 'none' }}>
      {image && (
        <div className="w-full md:w-36 aspect-video md:self-center shrink-0 flex-none bg-zinc-100 dark:bg-zinc-800 border-r border-zinc-200 dark:border-zinc-800">
          <img
            src={image}
            alt={title}
